# Drumpad  
The entire enclosure is 3D printed using an Ender 3 Pro using PLA using 0.2mm layer height. To improve printing time, a larger layer height with a larger nozzle will help.  
